...
>
  {/* WhatsApp Button */}
<a
  href="https://chat.whatsapp.com/KqNmfIapdWE7ntw7D1DRAx"
  target="_blank"
...
>
  <motion.button
    ...
    className="w-full px-6 py-3 rounded-xl font-semibold flex items-center justify-center gap-2 
      ...
      text-white 
      shadow-[0_0_20px_rgba(34,197,94,0.5)] transition-all duration-300"
  >
  ...
  <a href="/" className="flex-1">
    <motion.button
      whileHover={{ scale: 1.02 }}
      whileTap={{ scale: 0.98 }}
      className="w-full px-6 py-3 rounded-xl font-semibold flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-400 hover:to-purple-400 transition-all duration-300 shadow-lg shadow-blue-500/20"
    >
